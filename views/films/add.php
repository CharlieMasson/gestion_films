	...
	<div class="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div class="max-w-md mx-auto">
				<div>
					<h1 class="text-2xl font-semibold">Ajouter un Film</h1>
				</div>
				<div class="divide-y divide-gray-200">
                    ...
                    <form class="space-y-6" method="POST">
                        ...
                        <div class="relative">
                            <input autocomplete="off" id="name" name="name" type="text" maxlength="50" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Nom" value="<?= isset($sentForm['name']) ? $sentForm['name'] : "" ?>">
                        ...
                        <div class="relative">
                            <input autocomplete="off" id="director" name="director" type="text" maxlength="50" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Réalisateur" value="<?= isset($sentForm['director']) ? $sentForm['director'] : "" ?>">
                        ...
                        <div class="relative">
                            <input autocomplete="off" id="type" name="type" type="text" maxlength="50" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Genre" value="<?= isset($sentForm['type']) ? $sentForm['type'] : "" ?>">
                        ...
                        <div class="relative">
                            <input autocomplete="off" id="scriptwriter" name="scriptwriter" type="text" maxlength="50" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Scénariste" value="<?= isset($sentForm['scriptwriter']) ? $sentForm['scriptwriter'] : "" ?>">
                        ...
                        <div class="relative">
                            <input autocomplete="off" id="production_company" name="production_company" type="text" maxlength="50" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Société de Production" value="<?= isset($sentForm['production_company']) ? $sentForm['production_company'] : "" ?>">
                        ...
                        <div class="relative">
                            <input autocomplete="off" id="release_year" name="release_year" type="number" maxlength="50" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Année de Sortie" value="<?= isset($sentForm['release_year']) ? $sentForm['release_year'] : "" ?>">
                        ...
                        <div class="relative">
                            <textarea autocomplete="off" id="synopsis" name="synopsis" maxlength="250" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Synopsis"><?= isset($sentForm['synopsis']) ? $sentForm['synopsis'] : "" ?></textarea>
                        ...
                        <div class="relative">
                            <button type="submit" name="submit" class="bg-blue-500 text-white rounded-md px-2 py-1">Ajouter</button>
